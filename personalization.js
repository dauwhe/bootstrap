...
bigButton.style.left = '163px';
bigButton.style.borderBottomRightRadius = '30px';
...
smallButton.style.left = '130px';
smallButton.style.borderTopLeftRadius = '30px';
smallButton.style.borderBottomLeftRadius = '30px';
...
nightButton.style.paddingLeft = '0px';
nightButton.style.left = '200px';
nightButton.style.borderBottomLeftRadius = '30px';
nightButton.style.borderTopLeftRadius = '30px';
nightButton.style.borderBottomRightRadius = '30px';
nightButton.style.borderTopRightRadius = '30px';
nightButton.style.height = '30px';
...
if (nightLink.value === "Night") {
  for (var i = 0; i < allIframes.length; i++) {
    ...
    allIframes[i].contentWindow.document.getElementsByTagName('html')[0].style.WebkitFilter = 'invert(1) hue-rotate(180deg)';
